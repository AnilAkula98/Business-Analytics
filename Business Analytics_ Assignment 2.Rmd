---
title: "Business Analytics_Assignment2"
...
```{r}
OnlineRetail<- read.csv("C:\\Users\\anila\\Desktop\\Online_Retail.csv")
...
OnlineRetail$InvoiceDate <- as.POSIXct(OnlineRetail$InvoiceDate, format = "%Y-%m-%d %H:%M:%S")
...
# Print the result
cat("Average days between consecutive purchases:", average_days_between_purchases, "days\n")
